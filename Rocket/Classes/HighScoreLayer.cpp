...
HighScoreLayer::HighScoreLayer(int lastScore) : currentScore(lastScore)
{
    ...
    title->setPosition(Point(160, 420));
    ...
    if (vectorScores.size() > 0)
    {
        for (unsigned int i = 0; i < vectorScores.size(); i++)
        {
            ...
            if (data.size() > 0)
            {
                ...
                label1->setPosition(Point(15, start_y - count * step - 2.0f));
                ...
                label2->setPosition(Point(160, start_y - count * step));
                ...
                label3->setPosition(Point(160, start_y - count * step));
    ...
    mainMenu->setPosition(Point(160, 58));
